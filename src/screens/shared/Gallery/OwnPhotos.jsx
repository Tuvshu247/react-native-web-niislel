...
export default function OwnPhotos({ data = [] }) {
    ...
    const selectedImage = data?.[selectedIndex]?.image_url
        ? `${IMAGE_URL}${data[selectedIndex].image_url}`
        : null;
...
const styles = StyleSheet.create({
    listContent: { paddingBottom: 16, paddingHorizontal: 16, flexGrow: 1 },
